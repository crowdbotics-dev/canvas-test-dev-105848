"""
Django settings for canvas_test_dev_105848 project.
...
ROOT_URLCONF = 'canvas_test_dev_105848.urls'
...
WSGI_APPLICATION = 'canvas_test_dev_105848.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "canvas_test_dev_105848 API",
    "DESCRIPTION": "API documentation for canvas_test_dev_105848 App",
    "VERSION": "v1",
}
